...
#define JOB_SPACE_EXPLORER "Space Explorer"
//Service
...
#define JOB_DISPLAY_ORDER_SPACE_EXPLORER 22
...
#define JOB_DISPLAY_ORDER_SECURITY_ASSISTANT 38 // monkestation edit: security assistants
